...
func MakeHandler(s Service) http.Handler {
	...
	mux.Handle("/add/head/menu", m.Handler(makeHeadMenuEndpoint(s)))
	// mux.Handle("/add/sub/menu", m.Handler(makeSubmenuEndpoint(s)))
	// mux.Handle("/list/menu", m.Handler(makeListHeadMenuEndpoint(s)))
	// mux.Handle("/get/sub/menu", m.Handler(makeListMenuEnpoint(s)))
	// mux.Handle("/remove/menu", m.Handler(makeRemoveMenuEndpoint(s)))
	// mux.Handle("/add/role", m.Handler(makeRoleAminEndpoint(s)))
	// mux.Handle("/list/role", m.Handler(makeListRolePermission(s)))
	// mux.Handle("/remove/role", m.Handler(makeRemoveRolePermission(s)))
	// mux.Handle("/manage/role/permission", m.Handler(makeEndpointManageRolePermission(s)))
